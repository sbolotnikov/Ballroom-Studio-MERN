    ...
    return (
        <div>
            <form className="add-session" onSubmit={handleFormSubmit}>
                ...
                <button type="submit" className="cuteBtn mb-4" id="addSessionBtn" disabled={createdSession}> {createdSession ? "Successfully Created A New Session" : "Create New Session"}</button>
            </form>
        </div>
    )
}
